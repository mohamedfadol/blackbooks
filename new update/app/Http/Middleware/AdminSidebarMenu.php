                ...
                $menu->dropdown(
                    ...
                    function ($sub) use ($enabled_modules) {
                        ...
                        if (auth()->user()->can('tax_rate.view') || auth()->user()->can('tax_rate.create')) {
                         ...
                         //Kitchen home
                        if (in_array('kitchen', $enabled_modules)) {
                            $sub->url(action([\App\Http\Controllers\Restaurant\KitchenController::class, 'home']),
                             __('restaurant.mng_kitchen'), ['icon' => 'fa fas fa-fire', 
                             'active' => request()->segment(1) == 'kitchen-home']);
                        }
