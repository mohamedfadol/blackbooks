...
class TransactionPaymentController extends Controller
{
     ...
     * @return void
     */
    public function __construct(TransactionUtil $transactionUtil, ModuleUtil $moduleUtil, RestrictionService $restrictionService)
    {
    ...
    public function getPayContactDue($contact_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('transaction_payment.pay_supplier_due_modal')->with(compact('contact_details', 'payment_types', 'payment_line', 'due_payment_type', 'ob_due', 'amount_formated', 'accounts'));
        }
    }
    ...
    public function postPayContactDue(Request $request)
    {
        ...
        try {
            ...
            if ($input['method']) {
                ...
                $this->restrictionService->payContactDue($input, $business_id, $user_id);
            }
