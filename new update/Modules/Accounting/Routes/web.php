...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('accounting')->group(function () {
    ...
    Route::get('journal-entry/journal_openning', [\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'journalOpenning']);
    Route::get('journal-entry/journal_company_general', [\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'journalCompanyGeneral']);
