...
class SellController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $query = Transaction::where('business_id', $business_id)->where('id', $id)
                    ...
                    'sell_lines.modifiers', 'sell_lines.lot_details', 'tax', 'sell_lines.sub_unit', 'table', 
                    'service_staff', 'sell_lines.service_staff', 'types_of_service', 'sell_lines.warranties', 'media']);
