<?php
 ...
 return [
     'product_stock_alert' => "المواد منخفضة المخزون. <br/> <small class = 'text-muted'> استنادًا إلى كمية تنبيه المادة المحددة في شاشة إضافة المادة. <br> اشتر هذا المادة قبل نهاية المخزون. </small>",
     ...
     'no_of_products_for_trending_products' => 'عدد المواد الشائعة للمقارنة في الجدول أدناه.',
     'top_trending_products' => "أفضل المواد مبيعا لمتجرك. <br/> <small class = 'text-muted'> طبق التصفيات لإيجاد الواد الشائعة  لفئة محددة ، والعلامة التجارية ، ومكان العمل ، إلخ. </small>",
     'sku' => "معرف المادة الفريد أو وحدة إدارة المخزون <br> <br>يبقيه فارغة لتوليد sku تلقائيا. <br> <small class = 'text-muted'> يمكنك تغيير بادئة sku في الإعدادات التجارية </small>",
     'enable_stock' => 'تفعيل أو تعطيل إدارة المخزون لمواد ما.',
     'alert_quantity' => "يتم تنبيهك عند وصول مخزون المواد أو انخفاضه إلى أقل من الكمية المحددة. <br> <br> <small class = 'text-muted'> سيتم عرض المواد ذات المخزون المنخفض في لوحة المعلومات - قسم تنبيه مخزون المواد. </small>",
     'product_type' => '<b> مواد واحد </b>: المادة بدون تبيانات <br> <b> المادة لها ثوابت </b>: المادة ذو الاختلافات مثل الحجم واللون وما إلى ذلك',
     'profit_percent' => "هامش الربح الافتراضي للمواد. <br> <small class = 'text-muted'> (<i> يمكنك إدارة الهامش الافتراضي في إعدادات المؤسسة. </small>",
     ...
     'order_status' => 'ستكون المواد المتوفرة في عملية الشراء هذه متاحة للبيع فقط إذا كانت <b> حالة الطلب </b> هي <b> العناصر مستلمة </b>.',
     'purchase_location' => 'الفرع الذى سيكون المادة المشترى متاحًا للبيع.',
     ...
     'default_profit_percent' => "هامش الربح الافتراضي للمواد. <br> <small class = 'text-muted'> يستخدم لحساب سعر البيع بناءً على سعر الشراء الذي تم إدخاله. <br/> يمكنك تغيير هذه القيمة للمواد الفردية عن طريق الإضافة </small>",
     ...
     'unit_allow_decimal' => 'الأرقام العشرية تسمح لك ببيع المواد ذات الصلة في الكسور.',
     'print_label' => 'إضافة مواد -> اختر المعلومات التي تريد عرضها في الملصقات -> حدد إعداد الباركود -> معاينة الملصقات -> طباعة',
