...
class SettingsController extends Controller
{
    ...
    public function saveSettings(Request $request)
    {
        ...
        try {
            ...
            Business::where('id', $business_id)->update(['accounting_settings' => json_encode($accounting_settings)]);
            ...
            foreach($accounting_default_map as $location_id => $details){
                BusinessLocation::where('id', $location_id)->update(['accounting_default_map' => json_encode($details)]);
            }
