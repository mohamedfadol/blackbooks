            ...
            <table class="table table-bordered table-striped" id="expense_category_table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->get( 'expense.account_name' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/expense_category/index.blade.php ENDPATH**/ ?>