        ...
        <table class="table table-bordered table-striped" id="journal_table">
            <thead>
                <tr>
                    ...
                    <th><?php echo app('translator')->get('lang_v1.original'); ?></th>
                    <th><?php echo app('translator')->get('lang_v1.number'); ?></th>
...
<script type="text/javascript">
    ...
    $(document).ready( function(){
        ...
        journal_table = $('#journal_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '/accounting/journal-entry/journal_company_general',
                data: {
                    type: type
                },
                data: function(d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\Modules\Accounting\Providers/../Resources/views/journal_entry/journal_company_general.blade.php ENDPATH**/ ?>