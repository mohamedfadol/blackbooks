			...
			<div class="col-md-4">
                ...
                <?php echo Form::label('account_parent', __( 'accounting::lang.account_parent' ) . ':*'); ?>
					...
					<div class="input-group">
						...
						<?php echo Form::select("account_id", $accounts, 'account_id', ['class' => 'form-control accounts-dropdown select2', 'id' => 'account_sub_type', 'style' => 'width:100%;']); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH C:\wamp64\www\pos\resources\views/contact/create.blade.php ENDPATH**/ ?>