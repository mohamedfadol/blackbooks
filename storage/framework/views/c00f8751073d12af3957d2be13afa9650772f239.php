...
<div class="row <?php if($index !== 0): ?>hide <?php endif; ?>" id="add_contact_person_div_<?php echo e($index, false); ?>">
	...
	<div class="col-md-6">
		<div class="form-group">
		    ...
		    <?php echo Form::text($index === '' ? 'contact_no' : "contact_persons[$index][contact_no]", !empty($user->contact_no) ? $user->contact_number : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.mobile_number'), 'id'=>"contact_number$index" ]); ?>
	...
	<div class="col-md-6">
        <div class="form-group">
          <?php echo Form::label("cmmsn_percent$index", __( 'lang_v1.cmmsn_percent' ) . ':'); ?>

            <?php echo Form::text("contact_persons[$index][cmmsn_percent]", !empty($user->cmmsn_percent) ? $user->cmmsn_percent : null, ['class' => 'form-control input_number', 'placeholder' => __( 'lang_v1.cmmsn_percent' ), 'id' => "cmmsn_percent$index" ]); ?>
...
</div><?php /**PATH C:\wamp64\www\pos\Modules\Crm\Providers/../Resources/views/contact_login/partial/contact_login_from.blade.php ENDPATH**/ ?>