...
<section class="content">
	...
	<div class="box box-solid">
		<div class="box-body">
			...
			<input type="hidden" name="saleType" value="expense"/>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<?php echo Form::select('contact_id', $contacts, null, ['class' => 'form-control select2','required' ,'placeholder' => __('messages.please_select')]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/expense/create.blade.php ENDPATH**/ ?>