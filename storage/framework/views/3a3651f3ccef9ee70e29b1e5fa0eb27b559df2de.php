...
<input type="hidden" id="item_addition_method" value="<?php echo e($business_details->item_addition_method, false); ?>">
	<?php echo Form::open(['url' => action([\App\Http\Controllers\SellPosController::class, 'store']), 'method' => 'post', 'id' => 'add_sell_form', 'files' => true ]); ?>
	 ...
	 <?php if(!empty($sale_type)): ?>
	 	<input type="text" id="sale_type" name="type" value="<?php echo e($sale_type, false); ?>">
	 <?php endif; ?>
	 <input type="hidden" name="saleType" value="sale">
	<div class="row"> 
					...
					<table class="table table-condensed table-bordered table-striped">
						<tr>
							<td>
								...
								<b><?php echo app('translator')->get('sale.total_tax'); ?>: </b>
								<span class="custom_tex_total">0</span>
								&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="modal fade contact_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
	<?php echo $__env->make('contact.create', ['quick_add' => true, 'accounts' => $accounts], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
<!-- /.content -->
